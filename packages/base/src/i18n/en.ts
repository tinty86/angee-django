...
export const enBaseMessages: Record<string, string> = {
  ...
  "chrome.help": "Help",
  "chrome.globalSearch": "Global search",
  "chrome.openGlobalSearch": "Open global search",
  "chrome.searchEverywhere": "Search everywhere",
  "chrome.noResults": "No matching results.",
  "chrome.searchHint": "Type a search query to begin.",
