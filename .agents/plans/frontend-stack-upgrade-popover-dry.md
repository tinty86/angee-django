...
- ⏳ **`ui/` primitives parity — IN PROGRESS, batched** (Codex runtime is flaky → small batches limit blast radius):
  ...
  - [ ] done [ ] verified [ ] checked by human (final qa) — **disclosure batch**: accordion, collapsible, drawer/sheet, toggle, toggle-group/segmented + stories
  - [ ] done [ ] verified [ ] checked by human (final qa) — **overlay/menu batch**: dropdown-menu, context-menu, navigation-menu, command, selection-bar + stories
  - [ ] done [ ] verified [ ] checked by human (final qa) — **input batch**: slider, number-field, calendar, radio-group, form + stories
